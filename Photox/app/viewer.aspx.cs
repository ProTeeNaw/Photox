...
namespace Photox.app
{
    public partial class viewer : System.Web.UI.Page
    {
        ...
        protected async void Share(object sender, EventArgs e)
        {
            ...
            //var email = AllUserNames.SelectedValue;

            //GetUsersResult result = await FirebaseAuth.DefaultInstance.GetUsersAsync(
            //new List<UserIdentifier>
            //{
            //    new EmailIdentifier(email),
            //});
            ...
            //    DocumentReference docRef = db.Collection(user.Uid).Document(userRecord.Uid);
        ...
        protected void Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand SqlComm = new SqlCommand($"DELETE FROM Image WHERE Id = CONVERT(int, {DeleteText.Text})", connect);
